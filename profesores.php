...
?> </button>
    ...
    <form action="solicitudesp.php" method="POST">
        <div id="contenedor">
            <div id="central">
                <div id="login">
                    <div class="titulo">
                    ...
                    <form id="loginform">
                        Nombre<input type="text" name="estudiante" required>
                        Asignatura<input type="text" name="rut" required>          
                        Fecha Esperada de Reposicion<input type="date" name="fecha" required>
                        Materiales : <br/><textarea name="materiales"> </textarea>
