...
$insertar ="insert into solicitudes values('$id', '$estudiante','$rut','$fecha','$materiales')";
...
if($final){
    echo "<script>alert('Los Datos an sido registrados correctamente'); window.location='usuario.php';</script>";
}else{
