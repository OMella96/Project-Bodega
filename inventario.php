...
$insertar ="insert into inventario values('$id', '$producto','$cantidad')";
...
if($final){
    echo "<script>alert('Los Datos an sido registrados correctamente'); window.location='adm.php';</script>";
}else{
